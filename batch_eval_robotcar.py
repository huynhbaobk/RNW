...
if __name__ == '__main__':
    ...
    for ck in _EVAL_CHECK_POINTS:
        result_file_name = os.path.join(curr_dir, f'checkpoints/{_EXPERIMENT}/', 'rc_results/', 'result_{}.json'.format(ck))
        cmds = [
            'cd {}'.format(curr_dir),
            'python test_robotcar_disp.py {} {} {} --visualization'.format(_DS_ROOT, _CONFIG, f'checkpoints/{_EXPERIMENT}/checkpoint_epoch={ck}.ckpt'),
            'cd evaluation',
